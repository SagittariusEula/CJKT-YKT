...
import it.internet.ykt.wechat.utils.ConstantPropertiesUtil;
import it.internet.ykt.wechat.utils.HttpClientUtils;
import io.swagger.annotations.ApiOperation;
...
public class MenuController {
    ...
    public Result getAccessToken() {
        try {
            ...
            e.printStackTrace();
            throw new YunKtException(20001,"获取access_token失败");
        }
    }
}

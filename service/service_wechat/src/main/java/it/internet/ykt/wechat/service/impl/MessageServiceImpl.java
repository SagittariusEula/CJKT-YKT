...
import it.internet.ykt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        String openid = "o1snX6EQIOMo_izyk17AYkg4Pvxw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("6qCYfBZWyyK2LdP4GfgBvtsOw5EOzooo-T0pDhQGNi8")//模板id
                .url("http://qingykt1.vipgz1.91tunnel.com/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
        ...
        templateMessage.addData(new WxMpTemplateData("keyword3", "2023-04-25", "#272727"));
    ...
    private String aboutUs(Map<String, String> param) {
        return this.text(param, "云课堂现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、" +
                "人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程；同时，" +
                "通过视频分享、云课堂、大厂学苑直播课堂等多种方式，满足了全国编程爱好者对多样化学" +
                "习场景的需求，已经为行业输送了大量技术人才。").toString();
    }
    ...
    private String subscribe(Map<String, String> param) {
        //处理业务
        return this.text(param, "感谢你关注云课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
    ...
    private String search(Map<String, String> param) {
        ...
        if(CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://qingykt.vipgz4.91tunnel.com/#/liveInfo/"+course.getId()+"]]></Url>");
            articles.append("</item>");

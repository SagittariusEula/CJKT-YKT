...
public class QcloudTest {
    public static void main(String[] args) {
         ...
         * SECRETID和SECRETKEY请登录访问管理控制台
         * https://console.cloud.tencent.com/cam/capi 进行查看和管理
         */
        String secretId = "AKIDMabRbWAajeLwNccNtdBUYO2WmmW2Thjf";
        String secretKey = "nLhroZ6RaU9f1JPIwSkofGev0rcGhu32";
        ...
        try{
            // 指定要上传的文件
            File localFile = new File("C:\\Users\\ASUS\\Desktop" +
                    "\\新建文件夹 (6)\\12.jpg");
            // 指定文件将要存放的存储桶
            String bucketName = "ykt-2023-1317048096";
            /**
             * 指定文件上传到 COS 上的路径，即对象键。例如对象键为folder/picture.jpg，
             * 则表示将文件 picture.jpg 上传到 folder 路径下
             */
            String key = "test-12.png";

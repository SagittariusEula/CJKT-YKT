...
import it.internet.cjkt.model.live.*;
...
public class LiveCourseServiceImpl extends ServiceImpl<LiveCourseMapper, LiveCourse> implements LiveCourseService {
    ...
    public void saveLive(LiveCourseFormVo liveCourseFormVo) {
        ...
        try {
            String res = mtCloudClient.courseAdd(liveCourse.getCourseName(),
                    ...
                    new DateTime(liveCourse.getStartTime())
                            .toString("yyyy-MM-dd HH:mm:ss"),
                    new DateTime(liveCourse
                            .getEndTime()).toString("yyyy-MM-dd HH:mm:ss"),
                    teacher.getName(),
                    teacher.getIntro(),
                    options);
            System.out.println("res:"+res);
            //把创建之后返回结果判断
            CommonResult<JSONObject> commonResult =
                    JSON.parseObject(res, CommonResult.class);
            if(Integer.parseInt(commonResult.getCode()) ==
                    MTCloud.CODE_SUCCESS) { //成功
                //添加直播基本信息
                ...
                throw new YunKtException(20001,"直播创建失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void removeLive(Long id) {
        ...
        if(liveCourse != null) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new YunKtException(20001,"删除直播课程失败");
            }
        }
    }
    ...
    public void updateLiveById(LiveCourseFormVo liveCourseFormVo) {
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new YunKtException(20001,"修改直播课程失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public JSONObject getAccessToken(Long id, Long userId) {
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new YunKtException(20001,"获取失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void updateLifeConfig(LiveCourseConfigVo liveCourseConfigVo) {
        ...
        try {
            ...
            CommonResult<JSONObject> commonResult = JSON.parseObject(res, CommonResult.class);
            if(Integer.parseInt(commonResult.getCode()) != MTCloud.CODE_SUCCESS) {
                throw new YunKtException(20001,"修改配置信息失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

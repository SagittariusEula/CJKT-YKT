package it.internet.ykt.live.api;
...
public class LiveCourseApiController {
    ...
    @ApiOperation("查询所有的直播课程")
    @GetMapping("list")
    public Result FindAllLive(){
        List<LiveCourse> list = liveCourseService.list();
        return Result.ok(list).message("加载成功");
    }
}

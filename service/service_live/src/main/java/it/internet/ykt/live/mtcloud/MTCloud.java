...
package it.internet.ykt.live.mtcloud;

import it.internet.ykt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "56441";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "73538e2684749f3014da2e3196ab6a16";

...
import it.internet.utils.HttpClientUtils;
import it.internet.ykt.order.service.WXPayService;
...
public class WXPayServiceImpl implements WXPayService {
    ...
    public Map<String, Object> createJsapi(String orderNo) {
        ...
        //服务号商户号  固定值
        paramMap.put("mch_id", "1317048096");
        paramMap.put("nonce_str", WXPayUtil.generateNonceStr());
        paramMap.put("body", "test");
        paramMap.put("out_trade_no", orderNo);
        paramMap.put("total_fee", "1");//为了测试，支付0.01
        paramMap.put("spbill_create_ip", "127.0.0.1");
        paramMap.put("notify_url", "http://ykt.qing.cn/api/order/wxPay/notify");
        ...
        * */
        //TODO 一会完善代码
        paramMap.put("openid", "o1snX6EQIOMo_izyk17AYkg4Pvxw");
        ...
        try {
            ...
            if(null != resultMap.get("result_code")  && !"SUCCESS".equals(resultMap.get("result_code"))) {
                throw new YunKtException(20001,"支付失败");
            }
            ...
            result.put("appId", "wx3ccb927040a649a2");
